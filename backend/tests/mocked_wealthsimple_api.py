...
class MockedWealthSimpleAPI(IWealthSimpleAPI):
    seed: dict = {
        ...
        'stocks': [
            WSStock(id=9162481200008143540, ws_id='sec-s-3e036b4205684dd89faf37fe5b0e13af', name='National Bank Of Canada', type='equity', symbol='NA', currency='CAD', exchange='TSX', price=92.17, can_use_fractional=True, buyable=True, eps=9.7374, pe=9.47, beta=1.1517, high52=104.83, low52=82.16, ex_dividend_date=1663891200, dividend_yield=0.0494),
            WSStock(id=8096130168390492833, ws_id='sec-s-62d0287aaad241749fcb3982c92509e4', name='Hamilton Enhanced U.S. Covered Call ETF - Canadian Hedged', type='exchange_traded_fund', symbol='HYLD', currency='CAD', exchange='TSX', price=11.91, can_use_fractional=False, buyable=True, eps=None, pe=None, beta=1.617, high52=17.27, low52=10.64, ex_dividend_date=None, dividend_yield=0.1171),
            WSStock(id=1928698703642960138, ws_id='sec-s-806428a6a78c4df7be22fc4bc014b5dd', name='Canoe EIT Income Fund', type='equity', symbol='EIT.UN', currency='CAD', exchange='TSX', price=13.37, can_use_fractional=False, buyable=True, eps=1.6158, pe=8.27, beta=1.0682, high52=14.89, low52=12.04, ex_dividend_date=None, dividend_yield=0.0898),
            WSStock(id=2229126502340896008, ws_id='sec-s-a01e4c0037344ff5a514e554258b552c', name='Labrador Iron Ore Royalty Corp', type='equity', symbol='LIF', currency='CAD', exchange='TSX', price=34.28, can_use_fractional=True, buyable=True, eps=4.673, pe=7.34, beta=1.0549, high52=51, low52=25.24, ex_dividend_date=1664323200, dividend_yield=0.1036),
            WSStock(id=7350766160146080051, ws_id='sec-s-aee2d0052b904ee5bb08bf2f4e9f4983', name='Hamilton Enhanced Multi Sector Covered Call ETF Class E', type='exchange_traded_fund', symbol='HDIV', currency='CAD', exchange='TSX', price=15.74, can_use_fractional=False, buyable=True, eps=None, pe=None, beta=1.45, high52=19.39, low52=13.91, ex_dividend_date=None, dividend_yield=0.0943),
            WSStock(id=1561780008406852115, ws_id='sec-s-b34b6f1624234270b2862dc4f50e9b4c', name='Harvest Diversified Monthly Income ETF - Class A', type='exchange_traded_fund', symbol='HDIF', currency='CAD', exchange='TSX', price=8.0, can_use_fractional=False, buyable=True, eps=None, pe=None, beta=0.9963, high52=10.35, low52=7.16, ex_dividend_date=None, dividend_yield=0.0708),
            WSStock(id=6255349601691837577, ws_id='sec-s-bc862eacf0b043acb7ff18c8107200aa', name='Global Dividend Growth Split Corp - Class A', type='equity', symbol='GDV', currency='CAD', exchange='TSX', price=10.71, can_use_fractional=False, buyable=True, eps=None, pe=None, beta=1.1644, high52=13.04, low52=9.23, ex_dividend_date=None, dividend_yield=0.112),
            WSStock(id=4467138413975970390, ws_id='sec-s-cac48e23f5b84b4787b97628581ce59f', name='Bank of Nova Scotia', type='equity', symbol='BNS', currency='CAD', exchange='TSX', price=66.38, can_use_fractional=True, buyable=True, eps=8.0484, pe=8.25, beta=1.0024, high52=95, low52=63.19, ex_dividend_date=1664755200, dividend_yield=0.0612),
            WSStock(id=3156432814975853192, ws_id='sec-s-d4047f55ea8f46f698439b7b6c3e07d0', name='Barrick Gold Corp.', type='equity', symbol='ABX', currency='CAD', exchange='TSX', price=23.61, can_use_fractional=True, buyable=True, eps=None, pe=None, beta=0.4651, high52=33.0164, low52=17.822, ex_dividend_date=None, dividend_yield=0.0356),
            WSStock(id=1375778513932822493, ws_id='sec-s-e84cc1efee3447a5b9f21e6f47cc6799', name='BMO Canadian High Dividend Covered Call ETF', type='exchange_traded_fund', symbol='ZWC', currency='CAD', exchange='TSX', price=17.36, can_use_fractional=True, buyable=True, eps=None, pe=11.265, beta=0.9969, high52=20.4, low52=16.15, ex_dividend_date=1604966400, dividend_yield=0.0691)
        ],
